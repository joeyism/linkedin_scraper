...
class Company(Scraper):
    ...
    def __init__(
        ...
        self.showcase_pages = showcase_pages or []
        self.affiliated_companies = affiliated_companies or []
    ...
    def __parse_employee__(self, employee_raw):
        try:
            ...
            employee_object["linkedin_url"] = employee_raw.find_element(
                By.TAG_NAME, "a"
            ).get_attribute("href")
    ...
    def scrape_logged_in(self, get_employees=True, close_on_complete=True):
        ...
        try:
            ...
            driver.find_element(
                By.ID, "org-related-companies-module__show-more-btn"
            ).click()

            # get showcase
            for showcase_company in showcase.find_elements(
                By.CLASS_NAME, "org-company-card"
            ):
            ...
            for affiliated_company in showcase.find_element(
                By.CLASS_NAME, "org-company-card"
            ):
                companySummary = CompanySummary(
    ...
    def scrape_not_logged_in(
        ...
        self.about_us = driver.find_element(
            By.CLASS_NAME, "basic-info-description"
        ).text.strip()
        ...
        try:
            ...
            showcase_pages = driver.find_elements(
                By.CLASS_NAME, "company-showcase-pages"
            )[1]
            for showcase_company in showcase_pages.find_elements(By.TAG_NAME, "li"):
                ...
                companySummary = CompanySummary(
                    linkedin_url=name_elem.find_element(By.TAG_NAME, "a").get_attribute(
                        "href"
                    ),
            ...
            for i, affiliated_page in enumerate(
                ...
                if i % 3 == 0:
                    affiliated_pages.find_element(
                        By.CLASS_NAME, "carousel-control-next"
                    ).click()

                companySummary = CompanySummary(
                    linkedin_url=affiliated_page.find_element(
                        By.TAG_NAME, "a"
                    ).get_attribute("href"),
